...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        if ($availability == 1) {
            // Check if faculty initial is already in cosupervisor table
    ...
    <div class="content">
      ...
      <div class="card">
        <form id="cosupervisorForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
          ...
          <div class="page-info">
            <p>After submission, this information will be displayed on the Co-Supervisor page visible to students. Students can view your profile and research interests when selecting a thesis co-supervisor.</p>
          </div>
